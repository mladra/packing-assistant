...
public class DateToOnFocusChangeListener implements View.OnFocusChangeListener {
    private static final String DATE_FORMAT_STR = "dd-MM-yyyy";

    private AddPackingListActivity parent;

    public DateToOnFocusChangeListener(AddPackingListActivity parent) {
        this.parent = parent;
    }
    ...
    private void showDatePickerDialog(final View v) {
        ...
        final DatePickerDialog datePickerDialog = new DatePickerDialog(parent, new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                //TODO: mladra: Add validation to date (cannot be before the first one)
                parent.getCreationParameters().getRangeDate()[1] = cal.getTime();
            }
